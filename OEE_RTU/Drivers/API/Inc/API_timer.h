...
//General timer configs, max. 255.
#define TIMEOUTS_COUNT 20
...
typedef struct{
	...
	Timer_t * delay;				/*!< controlador de tiempo para el generador de patrones  */
...
/**
 * @brief Inicializa los timers y el array de timeouts.
 * @retval None
 */
void initTimers();
